...
\begin{enumerate}
  ...
  \item We continue by choosing the hyper-parameter \texttt{maxit}. \texttt{maxit} is the maximum number of itterations in the algorithm's search for the minimum of the liklihood. We choose \texttt{maxit} as 10000 because it finds a balance in computational feasibility and accuracy.  
