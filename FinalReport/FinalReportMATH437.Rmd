...
In order to perform QDA, we need to ensure that each group has at least as many entries as there are variables. Since there's only 8 variables, and 268/500 elements in each group (Diabetics vs not).
