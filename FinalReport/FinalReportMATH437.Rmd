...
Finally, we  check the assumption of the absence of multicollinearity by plotting the covariates against one another. Upon looking at the below plots, we see no noticable trends, including linear trends. Therefore -- since no two covariates appear to be strongly linearly associated with each other (MAYBE EXCEPT THICC VS BMI LMAO) -- we conclude that this assumtion is valid. As such, we can conclude that Logistic Regression is reasonably appropriate for classifying the diabetic status of individuals in the Pima Indian population.
