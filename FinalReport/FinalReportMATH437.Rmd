...
The data was cleaned by removing all datapoints which reported a zero for BMI, glucose concentration, blood pressure, or tricep thickness, as these values were entered as placeholders. The original dataset had 768 observations, which was reduced to 532 after being cleaned.
...
TODO -> PRIOR PARAMETER SELECTION JUSTIFICATION. Show dist of obs by class and argue from there.
...
1. Classes have >= obs as total features. Ref the table. Count the number of features.
2. The covs have different cov matrices (model takes care of this).
3. Multivariate normal. Hists.
