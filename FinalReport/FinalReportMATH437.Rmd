...
\begin{enumerate}
  ...
  \item We continue by choosing the hyper-parameter \texttt{maxit} as 10000. Through trial and error, we know that as \texttt{maxit} increases, the local minimum stabilizes our estimation of the liklihood. We find 10000 to be a good balance of computational feasibility and accuracy.    
...
TODO -> Explain only assumption left is absence of collinearity.
DANKNUGGIES.
